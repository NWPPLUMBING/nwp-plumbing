  ...
  return (
    <>
      <style>{`
        ...
        .promo-card-1 { padding:36px 48px; border-right:1px solid rgba(255,255,255,0.2); background:#a4151a; }
        .promo-card-2 { padding:36px 48px; background:#831015; }
        @media(max-width:768px){
          .promo-grid { grid-template-columns:1fr; }
          .promo-card-1 { border-right:none; border-bottom:1px solid rgba(255,255,255,0.2); padding:28px 24px; }
          .promo-card-2 { padding:28px 24px; }
        }
      `}</style>
      <div style={{overflow:'hidden'}}>
        <div className="promo-grid">
          ...
          <div className="promo-card-1">
            ...
            <div style={{fontSize:'3.8rem',fontWeight:800,color:'#fff',lineHeight:1,letterSpacing:'-0.03em',marginBottom:'10px'}}>
              $99
            </div>
          ...
          <div className="promo-card-2">
            ...
            <div style={{fontSize:'1.2rem',fontWeight:700,color:'#fff',marginBottom:'8px'}}>Whole Home Water Filtration</div>
            <p style={{fontSize:'0.9rem',color:'rgba(255,255,255,0.75)',lineHeight:1.6,marginBottom:'20px'}}>
              Clean, filtered water from every tap in your home. NWP Plumbing supplies and installs complete whole-home filtration systems, protecting your family, your appliances and your pipes. Fixed quote, professional install, no mess.
            </p>
            <a href="#filtration" style={{display:'inline-flex',alignItems:'center',gap:'8px',background:'#fff',color:'#a4151a',fontWeight:700,fontSize:'0.9rem',textDecoration:'none',padding:'12px 22px',borderRadius:'6px'}}>
              Learn more
            </a>
          </div>
